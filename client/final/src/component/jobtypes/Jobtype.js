...
useEffect(() => {
  ...
  const respons= await fetch("https://mhr.mhrguardtracking.com/job_list.php?userId="+localStorage.getItem("userId")) ;
...
const jobUpdate= (i,j)=>{
  navigate("/Jobcard", {state:{id:i,job:j}})
};
// searching 
const handleSearch=(e)=>{
  const cc =e.target.value;
  const ff =cc.toLowerCase()
  setQuery(ff);
}
  ...
  return (
    ...
    <div className="job-type-main-subadmin">
      <div className="job-type-body">
        <div style={{ display: old, }}>
          ...
          >
            <div className="job-search-div">
              ...
              <input className="input"  placeholder="Search Here" onChange={(e)=>handleSearch(e)} />
            </div>
            <div
       ...
       return (
        ...
        {/* After display None */}
        <div className="subadmin-job-body-dialogbox" style={{ display: again }}>
