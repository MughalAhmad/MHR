...
import "./Guardlistdetails.css";
import Header from "../header/Header";
import { Outlet,useLocation,useNavigate } from "react-router-dom";
import axios from "axios";

const Guardlistdetails = () => {
...
navigate(-1);
  ...
  return (
    < div style={{width:"100vw",height:"100vh",backgroundColor:"#e6f4e1"}}>
    <Header/>
      <div className="subadmin-guard-update-dialogbox" >
...
export default Guardlistdetails;
