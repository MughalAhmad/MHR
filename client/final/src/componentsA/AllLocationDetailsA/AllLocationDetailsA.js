...
import "./AllLocationDetailsA.css";
import HeaderA from '../headerA/HeaderA';
import { useLocation, useNavigate } from 'react-router-dom';
import axios from 'axios';
const AllLocationDetailsA = () => {
    ...
    return (
        <div className='all-admin-update-loaction'>
        <HeaderA/>
            <div className="all-admin-location-update-dialogbox">
...
export default AllLocationDetailsA