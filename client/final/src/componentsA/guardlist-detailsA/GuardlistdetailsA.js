...
import "./GuardlistdetailsA.css";
import HeaderA from "../headerA/HeaderA";
import { Outlet,useLocation,useNavigate } from "react-router-dom";
import axios from "axios";

const GuardlistdetailsA = () => {
  ...
  const [first1,setfirst1] = useState(
    {
      ...
      guard_password:propGuardUpdate.state.guard_password,
      ...
      if(item.id===a){
        var ad=new Array(
          ...
          setfirst1({
              ...
              guard_password:item.guard_password,
...
const submitGuardUpdate = () =>{
  ...
  const sendGuardUpdate={
    ...
    guard_password:first1.guard_password,
...
navigate(-1);
  ...
  return (
    ...
    < div style={{width:"100vw",height:"100vh",display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:"#e6f4e1"}}>
      <div className="admin-guard-update-dialogbox" >
      ...
      onChange={handleGuardUpdate} value={first1.guard_password} /></div>
...
export default GuardlistdetailsA;
