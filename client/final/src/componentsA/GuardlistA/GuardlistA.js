...
const GuardlistA = () => {
  const propsubId=useLocation();
  const [first, setfirst] = useState({
    subId:propsubId.state.subId
  })
  console.log(first.subId)
  ...
  useEffect(() => {
    const getData = async()=>{
    const respons= await fetch("https://mhr.mhrguardtracking.com/guard_list.php?userId="+first.subId) ;
...
const forwo= (id,guard_name,guard_dob,guard_phone,guard_SIALicense,guard_email,guard_password,guardEmergenceNo,guardSIAExpire,guard_adress)=>{
  navigate("/GuardlistdetailsA", {state:{
    id:id,
...
const ForwordView=(id,guard_name,guard_dob,guard_phone,guard_SIALicense,guard_email,guard_password,guardEmergenceNo,guardSIAExpire,guard_adress,subId)=>{
  navigate("/ViewA", {state:{
    id:id,
    guard_name:guard_name,
    guard_dob:guard_dob,
    guard_phone:guard_phone,
...
return (
  <>
  <HeaderA/>
    <div className="admin-guard-list-main">
      <div className="admin-guard-list-body">
        <div style={{ display: even1}}>
          ...
          >
            <div className="admin-guard-list-search">
              {/* <button>Search</button> */}
              <input className="admin-guard-list-input"  placeholder="Search Here" onChange={(e)=>handleSearch(e)}/>
            </div>
            <div
          ...
          <table  className="admin-guard-table">
            <thead>
              <tr>
                <th >#</th>
                <th>Name</th>
       ...
       return (
        ...
        <div className="admin-guard-body-dialogbox" style={{ display: even2 }}>
